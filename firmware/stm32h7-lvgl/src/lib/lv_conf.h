...
#define LV_ATTRIBUTE_LARGE_RAM_ARRAY __attribute__((section(".sdram_buf")))
...
#if LV_USE_FS_FATFS
    #define LV_FS_FATFS_LETTER 'S'      /**< SD 카드 (FatFs) */
...
#define LV_USE_FS_LITTLEFS 1
    ...
    #define LV_FS_LITTLEFS_LETTER 'F'   /**< SPI Flash (littlefs) */
